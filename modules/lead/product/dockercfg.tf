locals {
  artifactory_user = data.kubernetes_secret.jenkins_artifactory_credential[0] ? data.kubernetes_secret.jenkins_artifactory_credential[0].data.username : ""
  artifactory_pass = data.kubernetes_secret.jenkins_artifactory_credential[0] ? data.kubernetes_secret.jenkins_artifactory_credential[0].data.password : ""
  harbor_pass      = data.kubernetes_secret.product-harbor-creds[0] ? data.kubernetes_secret.product-harbor-creds[0].data.AUTH : ""
}
